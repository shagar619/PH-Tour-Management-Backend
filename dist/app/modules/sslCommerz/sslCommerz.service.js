...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppError_1.default(http_status_codes_1.default.INTERNAL_SERVER_ERROR, "SSL Commerz Payment Initialization Failed!");
    }
});
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, `Payment Validation Error, ${error.message}`);
    }
});
exports.SSLService = {
    sslPaymentInit,
