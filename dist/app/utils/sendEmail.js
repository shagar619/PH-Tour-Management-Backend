...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, subject, templateName, templateData, attachments }) {
    try {
        ...
        const info = yield transporter.sendMail({
            ...
            subject: subject,
            html: html,
            attachments: attachments === null || attachments === void 0 ? void 0 : attachments.map(att => ({
        ...
        throw new AppError_1.default(http_status_codes_1.default.INTERNAL_SERVER_ERROR, `Failed to send email. Please try again later. Error: ${error.message}`);
    }
});
